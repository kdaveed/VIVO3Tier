...
public class UploadedFileHelper {
	...
	public FileInfo createFile(String filename, String mimeType,
		...
		log.info("Individual byteStream : " + byteStream);
		log.info("Individual byteStreamUri : " + bytestreamUri);
		log.info("Individual aliasUrl : " + aliasUrl);
		
		Individual file = createFileIndividual(mimeType, filename, byteStream);
		String fileUri = file.getURI();
 
		log.info("Saved file URI : " + fileUri);	
	...
	public void setImagesOnEntity(String entityUri, FileInfo mainInfo,
		...
		log.info("setImagesOnEntity : entityUri" + entityUri);
		Individual entity = individualDao.getIndividualByURI(entityUri);
		
		log.info("setImagesOnEntity : Individual entity" + entity);
	...
	public void saveHasImageEntity(String entityUri, FileInfo imageInfo) {
		...
		// Add the thumbnail file to the main image file.
		objectPropertyStatementDao.insertNewObjectPropertyStatement(new ObjectPropertyStatementImpl(
						entityUri, "http://files.org#hasImage",imageInfo.getUri()));
			
	}
	

	public void saveHasDocumentEntity(String entityUri, FileInfo documentInfo) {
		...
		// Add the thumbnail file to the main image file.
		objectPropertyStatementDao.insertNewObjectPropertyStatement(new ObjectPropertyStatementImpl(
						entityUri, "http://files.org#hasDocument", documentInfo.getUri()));
	...
	private Individual createFileIndividual(String mimeType, String filename,
		...
		log.info("createFileIndividual :   FS_FILENAME : " + filename);
		...
		log.info("createFileIndividual :   FS_MIME_TYPE : " + mimeType);
		...
		log.info("createFileIndividual :   FS_DOWNLOAD_LOCATION : " + byteStream.getURI());
